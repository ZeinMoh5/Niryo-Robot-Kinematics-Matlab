...
z5 = T05(1:3,3); 
origin5 = T05(1:3,4);
endEffectorPosition = T0E(1:3,4);

J1 = [cross(z0, endEffectorPosition - origin0); z0];
J2 = [cross(z1, endEffectorPosition - origin1); z1];
J3 = [cross(z2, endEffectorPosition - origin2); z2];
J4 = [cross(z3, endEffectorPosition - origin3); z3];
J5 = [cross(z4, endEffectorPosition - origin4); z4];
J6 = [cross(z5, endEffectorPosition - origin5); z5];
